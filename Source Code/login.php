...
<body class="hold-transition login-page bg-white">
  ...
  <a href="login.php"><img src="assets\uploads\logo.jpg" id="example1" ></a>
...
<div class="login-box" >
  ...
  <div class="card" id="example2" >
    <div class="card-body login-card-body" id="example2" >
    <center><h2><b>FEEDBACK FORM LOGIN</b></h2></center>
